...
public class SetmealController {
     ...
     * @return
     */
    @CacheEvict(value = "setmealCache", key = "#setmealDto.categoryId + '_' + #setmealDto.status")//清理指定key的缓存
    @PutMapping
     ...
     * @return
     */
    @CacheEvict(value = "setmealCache", allEntries = true)//allEntries删除该分类下所有数据
